...
class LessonOnBoarding extends StatefulWidget {
  const LessonOnBoarding({super.key});

  @override
  State<LessonOnBoarding> createState() => _LessonOnBoardingState();
}

class _LessonOnBoardingState extends State<LessonOnBoarding> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 6),
                Text(
                  "On Lessons Page you can read daily lessons & news, explore and learn! Welcome",
                  textAlign: TextAlign.center,
                  style: GoogleFonts.dmSans(
                    fontSize: 18,
                    fontWeight: FontWeight.w400,
